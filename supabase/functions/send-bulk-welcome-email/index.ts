  ...
  try {
    ...
    for (const user of users) {
      ...
      try {
        ...
        const planName = profile?.subscription_plan === 'premium' ? 'Premium' : 'Basic';
        const planFeatures = profile?.subscription_plan === 'premium' 
          ? `
                      ...
                      <tr>
                        <td style="padding: 40px 30px;">
                          ...
                          <p style="margin: 0 0 25px 0; color: #6b7280; font-size: 16px; line-height: 1.7;">
                            É com muita alegria que recebemos você na nossa comunidade! Sua conta no 
                            <strong style="color: #2A8C68;">Plano de Vida</strong> está pronta para uso.
                          </p>
