...
const emailTemplates = {
  ...
  pdf_share: (name: string) => ({
    subject: "[TESTE] Plano de Vida compartilhado com você",
    html: generateEmailWrapper(
      "#2A8C68",
      "Plano Compartilhado",
      `
        ...
        <p style="margin: 0 0 16px 0; color: #4b5563; font-size: 15px; line-height: 1.6;">
          Anderson Reis compartilhou um Plano de Vida com você.
        </p>
        <div style="background: #f3f4f6; padding: 12px 16px; border-radius: 6px; margin: 16px 0;">
          <p style="margin: 0 0 8px 0; color: #374151; font-size: 14px;">
          ...
          <p style="margin: 0; color: #6b7280; font-size: 13px; font-style: italic;">
            "Dá uma olhada no meu plano! Quero sua opinião."
          </p>
        </div>
        <p style="margin: 0 0 16px 0; color: #4b5563; font-size: 14px;">
          O arquivo PDF está anexado a este email.
        </p>
        ${getSimpleLink("https://planodevida.io", "Criar meu próprio plano")}
        <p style="margin: 20px 0 0 0; color: #4b5563; font-size: 14px;">
          Atenciosamente,<br>Equipe Plano de Vida
        </p>
      `
  ...
  plan_summary: (name: string) => ({
    subject: "[TESTE] Resumo do seu Plano de Vida",
    html: generateEmailWrapper(
      "#2A8C68",
      "Resumo do Plano",
      `
        ...
        <div style="background: #f3f4f6; padding: 16px; border-radius: 6px; margin: 16px 0;">
          ...
          <p style="margin: 0 0 8px 0; color: #4b5563; font-size: 13px;">Metas por área:</p>
