...
export default function Assinatura() {
  ...
  return (
    ...
    >
      {/* Green overlay - matching original design */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#2A8C68]/80 via-[#7BC8A4]/70 to-[#A8E6CE]/60" />
      ...
      <div className="absolute top-4 right-4 sm:top-6 sm:right-6 z-20">
        <Button
          onClick={handleLogin}
          variant="outline"
          className="bg-white/20 backdrop-blur-md border-white/40 text-white hover:bg-white/30 hover:text-white rounded-xl px-4 sm:px-6 py-2 font-semibold transition-all duration-300 shadow-lg"
        >
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8">
        ...
        <div className="w-full flex flex-col items-center animate-fade-in">
          ...
          {/* Main Card - Compact */}
          <Card className="w-full max-w-md border-0 overflow-hidden rounded-[24px] shadow-[0_20px_60px_-10px_rgba(42,140,104,0.35)]">
            <div className="absolute inset-0 rounded-[24px] p-[1px] bg-gradient-to-br from-white/40 via-[#A8E6CE]/30 to-white/20">
              <div className="w-full h-full rounded-[23px] bg-white/95 backdrop-blur-2xl" />
            </div>
            ...
            <div className="relative z-10">
              ...
              <div className="relative bg-gradient-to-r from-[#2A8C68] via-[#3d9d78] to-[#2A8C68] py-3 px-4">
                ...
                <p className="text-center text-white/80 text-xs mt-1">Acesso completo a todas as funcionalidades</p>
              </div>
              ...
              <CardContent className="p-4 sm:p-6 space-y-4 bg-white">
                ...
                <div className="text-center py-2">
                  ...
                  <div className="flex items-baseline justify-center gap-1 mt-1">
                    <span className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-[#2A8C68] via-[#7BC8A4] to-[#2A8C68] bg-clip-text text-transparent">
                      R$ 9,99
                    </span>
                    <span className="text-muted-foreground text-base">/mês</span>
                  </div>
                  <div className="mt-2 inline-flex items-center gap-1.5 bg-[#A8E6CE]/30 text-[#2A8C68] text-xs font-semibold px-3 py-1 rounded-full">
                ...
                <div className="space-y-2">
                  {benefits.map((benefit, index) => {
                    ...
                    return (
                      <div 
                        key={index} 
                        className="flex items-center gap-2 p-2 rounded-lg bg-[#A8E6CE]/10 hover:bg-[#A8E6CE]/20 transition-colors"
                      >
                ...
                <div className="space-y-2">
                  <Button
                    ...
                    disabled={loading}
                    className="w-full h-11 text-base font-bold rounded-xl bg-gradient-to-r from-[#2A8C68] via-[#7BC8A4] to-[#2A8C68] hover:from-[#238058] hover:via-[#6ab893] hover:to-[#238058] text-white shadow-lg shadow-[#2A8C68]/30 transition-all duration-300 hover:scale-[1.02] hover:shadow-[#2A8C68]/50"
                  >
                    {loading ? (
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="w-full h-11 text-base font-bold rounded-xl border-2 border-[#2A8C68] text-[#2A8C68] hover:bg-[#2A8C68] hover:text-white transition-all duration-300"
                  >
                    <div className="flex items-center gap-2">
