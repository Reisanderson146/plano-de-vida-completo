    ...
    <section className="py-16 md:py-24 px-4 relative overflow-hidden">
      ...
      >
        <div className="text-center">
          ...
          >
            Teste grátis por 7 dias. Cancele quando quiser, sem burocracia.
          </motion.p>
          ...
          >
            <Button
              onClick={onCtaClick}
              size="lg"
              className="group px-10 py-7 text-lg font-semibold bg-gradient-to-r from-primary to-emerald-600 hover:from-primary/90 hover:to-emerald-600/90 text-primary-foreground shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300"
            >
